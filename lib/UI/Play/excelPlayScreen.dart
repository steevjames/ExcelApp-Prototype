...
class ExcelPlayPage extends StatefulWidget {
  @override
  _ExcelPlayPage createState() => _ExcelPlayPage();
}

class _ExcelPlayPage extends State<ExcelPlayPage> {
  var tests;
  var isLiked;
  ...
  void initState() {
    ...
    for (int index = 0; index < 6; index++) {
      if(test[index]["status"]=="In Progress")
      {
        ...
        body: Container(
          child: TabBarView(
            children: [
              ...
              Column(
                ...
                children: <Widget>[Padding(padding: EdgeInsets.only(left:27,top:13,bottom:13),child:Text("Not Started",
              ...
              Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[Padding(padding: EdgeInsets.only(left:27,top:13,bottom:13),child: Text("In Progress",style: TextStyle(
                                                  fontSize: 24,
                                                  color: primaryColor,
                                                  fontWeight: FontWeight.w700)
                                                  ))]+ inProgress),
          ...
          ListView(children: <Widget>[
              Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[Padding(padding: EdgeInsets.all(12))]+ results
